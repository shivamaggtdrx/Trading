    ...
    <div className="page-enter">
      ...
      <header className="sticky top-0 z-30 glass-heavy safe-top border-b border-border/30">
        <div className="max-w-lg mx-auto flex items-center gap-3 px-3 py-2.5">
          ...
          <h1 className="text-sm font-bold text-text-primary">Preferences</h1>
        </div>
      </header>
      ...
      <div className="px-3 space-y-2.5 pb-3 pt-2">
        {/* Trading Defaults */}
        <div>
          <h3 className="text-[9px] font-bold text-text-muted uppercase tracking-wider mb-1.5 px-0.5">Trading Defaults</h3>
          <Card padding="p-0">
            <div className="divide-y divide-border/20">
              ...
              <div className="px-3 py-2.5">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <p className="text-[11px] font-semibold text-text-primary">Default Order Type</p>
                  </div>
                </div>
                <div className="flex gap-1 ml-9.5">
                  {['market', 'limit', 'stoploss'].map(type => (
                    <button key={type} onClick={() => setSettings(prev => ({ ...prev, defaultOrderType: type }))}
                      className={cn('flex-1 py-1.5 text-[9px] font-bold rounded-lg transition-all capitalize',
              ...
              <div className="flex items-center gap-3 px-3 py-2.5">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-semibold text-text-primary">Confirm Before Order</p>
                  <p className="text-[8px] text-text-muted mt-0.5">Show confirmation before placing orders</p>
                </div>
              ...
              <div className="flex items-center gap-3 px-3 py-2.5">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-semibold text-text-primary">One-Click Trading</p>
                  <p className="text-[8px] text-text-muted mt-0.5">Execute orders instantly without confirmation</p>
                </div>
        ...
        {/* Chart Settings */}
        <div>
          <h3 className="text-[9px] font-bold text-text-muted uppercase tracking-wider mb-1.5 px-0.5">Chart Settings</h3>
          <Card padding="p-0">
            <div className="divide-y divide-border/20">
              {/* Chart Type */}
              <div className="px-3 py-2.5">
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <p className="text-[11px] font-semibold text-text-primary">Chart Type</p>
                </div>
                <div className="flex gap-1 ml-9.5">
              ...
              <div className="px-3 py-2.5">
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <p className="text-[11px] font-semibold text-text-primary">Default Timeframe</p>
                </div>
                <div className="flex gap-1 ml-9.5">
              ...
              <div className="flex items-center gap-3 px-3 py-2.5">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-semibold text-text-primary">Show Order Book</p>
                  <p className="text-[8px] text-text-muted mt-0.5">Display bid/ask depth on chart</p>
                </div>
        ...
        <div>
          <h3 className="text-[9px] font-bold text-text-muted uppercase tracking-wider mb-1.5 px-0.5">App Settings</h3>
          <Card padding="p-0">
            <div className="divide-y divide-border/20">
              {/* Price Alerts */}
              <div className="flex items-center gap-3 px-3 py-2.5">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-semibold text-text-primary">Price Alerts</p>
                </div>
              ...
              <div className="flex items-center gap-3 px-3 py-2.5">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-semibold text-text-primary">Sound Effects</p>
                </div>
              ...
              <div className="flex items-center gap-3 px-3 py-2.5">
                ...
                <div className="flex-1">
                  <p className="text-[11px] font-semibold text-text-primary">Dark Mode</p>
                </div>
