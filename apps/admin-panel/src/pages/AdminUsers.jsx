          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 mx-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="email" value={newAdmin.email} onChange={e => setNewAdmin({...newAdmin, email: e.target.value})} className="w-full border border-gray-300 rounded-lg text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="user@tradex.com" />
              </div>
              <div>
