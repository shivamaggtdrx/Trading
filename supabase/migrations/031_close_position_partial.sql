-- ============================================================
-- TradeX — Migration 031: Partial Position Exit support
-- Adds public.close_position_partial_v2 function
-- ============================================================
...
BEGIN
  ...
  -- Swap fees: charge a proportional amount of the accumulated swap fees
  v_swap_fee_realized := (v_position.total_swap_fees * (v_target_exit_qty / v_position.quantity));
  v_charges := (v_spread_amount * v_target_exit_qty * 0.01) + v_swap_fee_realized;
  ...
  INSERT INTO public.trades (
    ...
    v_spread_amount * v_target_exit_qty * 0.01, v_swap_fee_realized, v_position.routing, v_position.opened_at, now()
