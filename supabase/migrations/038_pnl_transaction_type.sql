-- Migration: 038_pnl_transaction_type
-- Description: Updates close_position_v2, close_position_atomic, and close_position_partial_v2 to write wallet transactions of type 'trade_pnl', and updates existing records.

-- 1. Recreate close_position_v2
...
-- 2. Recreate close_position_atomic
...
-- 3. Recreate close_position_partial_v2
...
SET type = 'trade_pnl' 
WHERE description LIKE 'Realized PNL%' OR description LIKE 'Realized partial PNL%';
